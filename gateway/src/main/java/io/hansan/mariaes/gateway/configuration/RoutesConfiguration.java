...
public class RoutesConfiguration {
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                .route("service-user", r->r.path("/api/user/**")
                        .uri("lb://service-user"))
                .route("service-page", r->r.path("/api/page/**")
                        .uri("lb://service-page"))
                .route("service-exam", r->r.path("/api/exam/**")
                        .uri("lb://service-exam"))
                .route("service-question", r->r.path("/api/question/**")
                        .uri("lb://service-question"))
                .route("service-grade", r->r.path("/api/grade/**")
